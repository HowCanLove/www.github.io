(function(window) {
  ...
  Player = function(playerNode) {
    ...
    function getActionData(target) {
      ...
      actionData.volume.x = utils.position.getOffX(target) + target.parentNode.parentNode.parentNode.parentNode.offsetLeft;
      actionData.volume.y = utils.position.getOffY(target) + target.parentNode.parentNode.parentNode.parentNode.offsetTop;
    ...
    function init() {
      ...
      dom.volume = utils.dom.get(dom.o, '.sm2-volume-control');
